...
public:
  ...
  static void SetInfo(const Vector3& q, Vector3& closestPoint, Vector3& searchDirection, size_t& newSize, const Vector3& point);
  static void SetInfo(const Vector3& q, Vector3& closestPoint, Vector3& searchDirection, size_t& newSize, const Vector3& point1, const Vector3& point2, float u, float v);
  static Vector3 TriNoraml(const Vector3& p0, const Vector3& p1, const Vector3& p2, const Vector3& p3);
};
