...
void DynamicAabbTreeStructure1(const std::string& testName, FILE* file = NULL)
{
...
void DynamicAabbTreeStructure2(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeStructure3(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeStructure4(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeStructure5(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastTest1(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastTest2(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
// Simple results test
void DynamicAabbTreeFrustumCastTest1(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastTest2(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
// Check that the correct number of tests are performed
void DynamicAabbTreeFrustumCastTest3(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
// Check that the correct number of tests are performed
void DynamicAabbTreeFrustumCastTest4(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
// Check that the correct number of tests are performed
void DynamicAabbTreeFrustumCastTest5(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
// Check that the correct number of tests are performed
void DynamicAabbTreeFrustumCastTest6(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
// Check that the correct number of tests are performed
void DynamicAabbTreeFrustumCastTest7(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
// Check that the correct number of tests are performed
void DynamicAabbTreeFrustumCastTest8(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
// Check that the correct number of tests are performed
void DynamicAabbTreeFrustumCastTest9(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
// Check that the correct number of tests are performed
void DynamicAabbTreeFrustumCastTest10(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
// Check that the correct number of tests are performed
void DynamicAabbTreeFrustumCastTest11(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeSelfQuery1(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeSelfQuery2(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeStructureFuzzTest1(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeStructureFuzzTest2(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeStructureFuzzTest3(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeStructureFuzzTest4(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeStructureFuzzTest5(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeStructureFuzzTest6(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeStructureFuzzTest7(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeStructureFuzzTest8(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeStructureFuzzTest9(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeStructureFuzzTest10(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeStructureFuzzTest11(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeStructureFuzzTest12(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeStructureFuzzTest13(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeStructureFuzzTest14(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeStructureFuzzTest15(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeStructureFuzzTest16(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeStructureFuzzTest17(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeStructureFuzzTest18(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeStructureFuzzTest19(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeStructureFuzzTest20(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeStructureFuzzTest21(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeStructureFuzzTest22(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeStructureFuzzTest23(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeStructureFuzzTest24(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeStructureFuzzTest25(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest1(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest2(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest3(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest4(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest5(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest6(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest7(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest8(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest9(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest10(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest11(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest12(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest13(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest14(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest15(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest16(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest17(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest18(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest19(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest20(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest21(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest22(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest23(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest24(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest25(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest26(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest27(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest28(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest29(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest30(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest31(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest32(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest33(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest34(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest35(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest36(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest37(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest38(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest39(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest40(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest41(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest42(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest43(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest44(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest45(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest46(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest47(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest48(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest49(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeRayCastFuzzTest50(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest1(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest2(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest3(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest4(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest5(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest6(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest7(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest8(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest9(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest10(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest11(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest12(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest13(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest14(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest15(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest16(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest17(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest18(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest19(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest20(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest21(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest22(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest23(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest24(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest25(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest26(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest27(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest28(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest29(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest30(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest31(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest32(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest33(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest34(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest35(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest36(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest37(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest38(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest39(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest40(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest41(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest42(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest43(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest44(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest45(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest46(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest47(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest48(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest49(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void DynamicAabbTreeFrustumCastFuzzTest50(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest1(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest2(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest3(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest4(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest5(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest6(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest7(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest8(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest9(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest10(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest11(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest12(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest13(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest14(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest15(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest16(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest17(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest18(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest19(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest20(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest21(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest22(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest23(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest24(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest25(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest26(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest27(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest28(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest29(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest30(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest31(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest32(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest33(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest34(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest35(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest36(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest37(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest38(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest39(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest40(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest41(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest42(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest43(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest44(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest45(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest46(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest47(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest48(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest49(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void AabbTreeSelfQueryFuzzTest50(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
