...
void TestVoronoiRegions(const Vector3& q, std::vector<Vector3>& points, bool debugDraw, FILE* file = NULL)
{
  size_t newSize = 1;
  int newIndices[4] = {0};
...
void PointVoronoiRegions1(const std::string& testName, FILE* file = NULL)
{
...
void PointVoronoiRegions2(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, -1, 0));
...
void PointVoronoiRegions3(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, -1, 0));
...
void EdgeVoronoiRegions1(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, -1, 0));
  points.push_back(Vector3(0, 1, 0));
...
void EdgeVoronoiRegions2(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, -1, 0));
  points.push_back(Vector3(0, 1, 0));
...
void EdgeVoronoiRegions3(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, -1, 0));
  points.push_back(Vector3(0, 1, 0));
...
void EdgeVoronoiRegions4(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, -1, 0));
  points.push_back(Vector3(0, 1, 0));
...
void EdgeVoronoiRegions5(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, -1, 0));
  points.push_back(Vector3(0, 1, 0));
...
void EdgeVoronoiRegions6(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, -1, 0));
  points.push_back(Vector3(0, 1, 0));
...
void EdgeVoronoiRegions7(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, -1, 0));
  points.push_back(Vector3(0, 1, 0));
...
void EdgeVoronoiRegions8(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, -1, 0));
  points.push_back(Vector3(0, 1, 0));
...
void EdgeVoronoiRegions9(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, -1, 0));
  points.push_back(Vector3(0, 1, 0));
...
void EdgeVoronoiRegions10(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, -1, 0));
  points.push_back(Vector3(0, 1, 0));
...
void EdgeVoronoiRegions11(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, -1, 0));
  points.push_back(Vector3(0, 1, 0));
...
void TriangleVoronoiRegions1(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
...
void TriangleVoronoiRegions2(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1, 1));
  points.push_back(Vector3(0, 1, -1));
...
void TriangleVoronoiRegions3(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1, 1));
  points.push_back(Vector3(0, 1, -1));
...
void TriangleVoronoiRegions4(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1, 1));
  points.push_back(Vector3(0, 1, -1));
...
void TriangleVoronoiRegions5(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1, 1));
  points.push_back(Vector3(0, 1, -1));
...
void TriangleVoronoiRegions6(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1, 1));
  points.push_back(Vector3(0, 1, -1));
...
void TriangleVoronoiRegions7(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1, 1));
  points.push_back(Vector3(0, 1, -1));
...
void TriangleVoronoiRegions8(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1, 1));
  points.push_back(Vector3(0, 1, -1));
...
void TriangleVoronoiRegions9(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1, 1));
  points.push_back(Vector3(0, 1, -1));
...
void TriangleVoronoiRegions10(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1, 1));
  points.push_back(Vector3(0, 1, -1));
...
void TriangleVoronoiRegions11(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1, 1));
  points.push_back(Vector3(0, 1, -1));
...
void TriangleVoronoiRegions12(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1, 1));
  points.push_back(Vector3(0, 1, -1));
...
void TriangleVoronoiRegions13(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1, 1));
  points.push_back(Vector3(0, 1, -1));
...
void TriangleVoronoiRegions14(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
...
void TriangleVoronoiRegions15(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 1));
  points.push_back(Vector3(0, 2, -1));
...
void TriangleVoronoiRegions16(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 1));
  points.push_back(Vector3(0, 2, -1));
...
void TriangleVoronoiRegions17(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 1));
  points.push_back(Vector3(0, 2, -1));
...
void TriangleVoronoiRegions18(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 1));
  points.push_back(Vector3(0, 2, -1));
...
void TriangleVoronoiRegions19(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 1));
  points.push_back(Vector3(0, 2, -1));
...
void TriangleVoronoiRegions20(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 1));
  points.push_back(Vector3(0, 2, -1));
...
void TriangleVoronoiRegions21(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 1));
  points.push_back(Vector3(0, 2, -1));
...
void TriangleVoronoiRegions22(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 1));
  points.push_back(Vector3(0, 2, -1));
...
void TriangleVoronoiRegions23(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 1));
  points.push_back(Vector3(0, 2, -1));
...
void TriangleVoronoiRegions24(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 1));
  points.push_back(Vector3(0, 2, -1));
...
void TriangleVoronoiRegions25(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 1));
  points.push_back(Vector3(0, 2, -1));
...
void TriangleVoronoiRegions26(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 1));
  points.push_back(Vector3(0, 2, -1));
...
void TetrahedonVoronoiRegions1(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
...
void TetrahedonVoronoiRegions2(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions3(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions4(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions5(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions6(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions7(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions8(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions9(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions10(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions11(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions12(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions13(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions14(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions15(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions16(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions17(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions18(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions19(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions20(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions21(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions22(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions23(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions24(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions25(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions26(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions27(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions28(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions29(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions30(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions31(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions32(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions33(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions34(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions35(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions36(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions37(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions38(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions39(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(-1, -1, 1));
  points.push_back(Vector3(0, 2, 0));
...
void TetrahedonVoronoiRegions40(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(-1, -1, 1));
  points.push_back(Vector3(0, 2, 0));
...
void TetrahedonVoronoiRegions41(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(-1, -1, 1));
  points.push_back(Vector3(0, 2, 0));
...
void TetrahedonVoronoiRegions42(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(-1, -1, 1));
  points.push_back(Vector3(0, 2, 0));
...
void TetrahedonVoronoiRegions43(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions44(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions45(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions46(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions47(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 2, 0));
  points.push_back(Vector3(-1, -1, 1));
...
void TetrahedonVoronoiRegions48(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
...
void TetrahedonVoronoiRegions49(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions50(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions51(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions52(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions53(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions54(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions55(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions56(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions57(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions58(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions59(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions60(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions61(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions62(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions63(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions64(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions65(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions66(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions67(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions68(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions69(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions70(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions71(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions72(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions73(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions74(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions75(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions76(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions77(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions78(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions79(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions80(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions81(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions82(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions83(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions84(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions85(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions86(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(-0.2f, 1, 1));
  points.push_back(Vector3(0, 1.2f, 0));
...
void TetrahedonVoronoiRegions87(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(-0.2f, 1, 1));
  points.push_back(Vector3(0, 1.2f, 0));
...
void TetrahedonVoronoiRegions88(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(-0.2f, 1, 1));
  points.push_back(Vector3(0, 1.2f, 0));
...
void TetrahedonVoronoiRegions89(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(-0.2f, 1, 1));
  points.push_back(Vector3(0, 1.2f, 0));
...
void TetrahedonVoronoiRegions90(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions91(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions92(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions93(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void TetrahedonVoronoiRegions94(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, 1.2f, 0));
  points.push_back(Vector3(-0.2f, 1, 1));
...
void VoronoiRegionsStress1(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
...
void VoronoiRegionsStress2(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
  points.push_back(Vector3(0, -1, 0));
...
void VoronoiRegionsStress3(const std::string& testName, FILE* file = NULL)
{
  std::vector<Vector3> points;
...
void SphereSupport1(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void SphereSupport2(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void SphereSupport3(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void SphereSupport4(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void SphereSupport5(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void ObbSupport1(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void ObbSupport2(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void ObbSupport3(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void ObbSupport4(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void ObbSupport5(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkTest1(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkTest2(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkTest3(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkTest4(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkTest5(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkTest6(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkTest7(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkTest8(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkTest9(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkStressTest1(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkStressTest2(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkStressTest3(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkStressTest4(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkStressTest5(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void ShapeFuzzTest1(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void ShapeFuzzTest2(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void ShapeFuzzTest3(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void ShapeFuzzTest4(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void ShapeFuzzTest5(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void ShapeFuzzTest6(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void ShapeFuzzTest7(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void ShapeFuzzTest8(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void ShapeFuzzTest9(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void ShapeFuzzTest10(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void ShapeFuzzTest11(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void ShapeFuzzTest12(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void ShapeFuzzTest13(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void ShapeFuzzTest14(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void ShapeFuzzTest15(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest1(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest2(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest3(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest4(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest5(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest6(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest7(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest8(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest9(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest10(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest11(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest12(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest13(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest14(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest15(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest16(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest17(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest18(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest19(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest20(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest21(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest22(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest23(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest24(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest25(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest26(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest27(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest28(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest29(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest30(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest31(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest32(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest33(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest34(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest35(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest36(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest37(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest38(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest39(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest40(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest41(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest42(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest43(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest44(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest45(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest46(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest47(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest48(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest49(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest50(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest51(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest52(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest53(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest54(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest55(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest56(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest57(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest58(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest59(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest60(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest61(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest62(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest63(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest64(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest65(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest66(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest67(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest68(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest69(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest70(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest71(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest72(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest73(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest74(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest75(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest76(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest77(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest78(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest79(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest80(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest81(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest82(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest83(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest84(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest85(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest86(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest87(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest88(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest89(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest90(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest91(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest92(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest93(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest94(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest95(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest96(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest97(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest98(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest99(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest100(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest101(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest102(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest103(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest104(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
...
void GjkFuzzTest105(const std::string& testName, FILE* file = NULL)
{
  PrintTestHeader(file, testName);
